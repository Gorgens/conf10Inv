...
```{r flowchart, fig.align = 'center', out.width = "25%", fig.cap = "Avaliação do inventário florestal protocolado junto ao órgão ambiental. Vistoria-se parte do invnetario para determinar eventuais desvios."}
