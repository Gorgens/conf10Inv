...
```{r simulacaoNativa, echo=FALSE, eval=FALSE, message=FALSE}
...
```{r simulacaoLinear, echo=FALSE, eval=FALSE, message=FALSE}
...
```{r simulacaoPlantada, echo=FALSE, eval=FALSE, message=FALSE}
